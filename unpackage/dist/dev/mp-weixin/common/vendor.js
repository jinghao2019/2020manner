...
var _util = _interopRequireDefault(__webpack_require__(/*! @/common/lib/util.js */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  ...
  mutations: {
    ...
    selectItem: function selectItem(state, index) {
      var hashKey = state.list[index].hashKey;
      var i = state.selectedList.indexOf(hashKey);
      //之前选中,取消选中
      if (i > -1) {
        //取消当前商品状态
  ...
  actions: {
    ...
    updateCartList: function updateCartList(_ref) {var state = _ref.state,commit = _ref.commit;
      return new Promise(function (res, rej) {
        ...
        _request.default.get('/mannerdish/cart/getCart', {}, {
          token: true,
          toast: false }).
    ...
    // 增减购物车列表
    addCartList: function addCartList(_ref2, data) {var state = _ref2.state,commit = _ref2.commit;
      ...
      return new Promise(function (res, rej) {
        ...
        _request.default.get('/mannerdish/cart/addCartNum', { flag: flag, num: data.num, hashKey: data.hashKey }, {
          token: true,
          toast: false }).
        then(function (result) {
          setTimeout(function () {
    ...
    doDelGoods: function doDelGoods(_ref6) {var commit = _ref6.commit;
      uni.showModal({
        content: '是否删除',
        ...
        success: function success(result) {
          ...
          if (result.data.code != 1) {
            ...
            if (result.data.code == 200002 || result.data.code == 200003 || result.data.code == 200004 || result.data.code == 100001) {
              ...
              return uni.navigateTo({
                url: '/pages/mannerlogin/login?referer=/' + _curPage.__route__ });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _util = _interopRequireDefault(__webpack_require__(/*! @/common/lib/util.js */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  ...
  mutations: {
    ...
    initUser: function initUser(state) {
      var userInfo = _util.default.getCache('userInfo', '');
      if (userInfo) {
    ...
    login: function login(state, userinfo) {
      ...
      state.loginStatus = true;
      state.token = userinfo.token;
      _util.default.setCache("userInfo", userinfo, 7200);
      // // 持久化存储
    ...
    logout: function logout(state) {
      ...
      state.token = null;
      _util.default.removeCache('userInfo');
    } } };exports.default = _default;
