<template>
	<view class="all" style="height: 100%;box-sizing: border-box;">
			...
			<view class="content"  :style="{height:height+'px'}" >						
				...
				@scroll="onRightScroll">					
					<view class="row right-scroll-item" v-for="(item,index) in list" :key="index">
						<view class="u-f span24-24  py-2" v-for="(item2,index2) in item.goods" :key="index2" @click="show('attr',index,index2)">
							<view class="px-2">
			...
			<view class="goodscard" v-show="showattr">
				...
				<view  :class="specialcard? 'specialcardtop':'attr'">
					<view v-show="specialcard" style="height: 130upx;"></view>
					<view class="'attrtop">
					...
					<scroll-view scroll-y style="height: 500upx;"  :class="specialcard? 'specialcardtop1':''">
						<view class="check">
							...
							<view class="milk u-f" style="flex-wrap:wrap">
								<view>加冰</view>
								<view class="u-f" style="flex-wrap:wrap;width: 500upx;">
